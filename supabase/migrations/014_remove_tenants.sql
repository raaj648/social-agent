...
alter table public.connected_pages drop column if exists tenant_id cascade;
...
alter table public.instagram_accounts drop column if exists tenant_id cascade;
...
alter table public.whatsapp_accounts drop column if exists tenant_id cascade;
...
alter table public.knowledge_base drop column if exists tenant_id cascade;
...
alter table public.orders drop column if exists tenant_id cascade;
