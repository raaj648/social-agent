...
// Generate a fixup migration that only does the remaining work
const lines = [
...
writeFileSync("social-reply-ai/supabase/migrations/014b_fixup_remove_tenants.sql", lines.join("\n"));
console.log("Fixup migration written");
